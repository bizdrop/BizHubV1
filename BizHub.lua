...
function BizHubArsenal()
    ...
    local function isPlayerAllowed(playerId)
        ...
        for _, allowedId in ipairs(allowedPlayerIds) do
    ...
    local Window = Library.CreateLib("BizHub V1 | Game: Arsenal | Welcome " .. Name, colors)

    local Tab = Window:NewTab("Main")
    local Section = Tab:NewSection("Main:")
    --Main Shit Here
    Section:NewButton("No Falldamage", "If you click you will have no fall damage", function()
        game:GetService("ReplicatedStorage").Events.FallDamage:Destroy()
    end)

    Section:NewButton("Hitbox Extender", "If you click enemy hitboxes will become bigger.", function()
        spawn(function()
			while wait() do
    ...
    Section:NewButton("Gun Mod", "Fun mod for gun.", function()
    ...
    Section:NewButton("Kill all", "Press E and everyone will die.", function()
        ...
        local WeaponMechanics = require(ReplicatedStorage.Services.Weapons.WeaponMechanics)

        ReplicatedStorage.Weapons.Knife:SetAttribute("Range", 1000)
        ...
        local function getClosestPlayer()
            ...
            for _, otherPlayer in ipairs(Players:GetPlayers()) do
                if otherPlayer ~= Player and otherPlayer.Character and otherPlayer.Character:FindFirstChild("Head") and otherPlayer.Character:FindFirstChild("Gun") and otherPlayer.TeamColor ~= Player.TeamColor then
                    local dist = (otherPlayer.Character.Head.Position - Player.Character.Head.Position).Magnitude
        ...
        -- Credits to MMSVon for the following RunService loop
    ...
    Section:NewTextBox("Walk Speed", "Change your Walk Speed", function(speed)
        while true do
            wait()
    ...
    Section:NewToggle("Silent aim", "Toggles silent aim", function(silent)
        if silent then
    ...
    Section:NewToggle("Aimbot", "Toggle Aimbot", function(aimbot)
    local Players = game:GetService("Players")
    local RunService = game:GetService("RunService")
    ...
    Section:NewButton("Rapid Fire", "Press and you will have rapid fire", function()
...
for i, v in pairs(replicationstorage.Weapons:GetDescendants()) do
   ...
   if v.Name == "Crit" then
    ...
    Section:NewButton("Infinite ammo", "Turns on infinite ammo", function()
        while wait() do
    ...
    local J = false;
    Section:NewToggle("Bunny Hop", "Toggle's Bunny hop", function(K)
        J = K;
        spawn(function()
        while wait()
    ...
    Section:NewToggle("Anti Aim", "Enemy cant shoot at you as much", function(value)
        if value then
    ...
    Section:NewToggle("ESP", "Toggle's ESP", function(box)
...
Section:NewToggle("Tracers", "Toggle's tracers", function(tracer)
    local function API_Check()
        if Drawing == nil then
    ...
    if Success and not Errored then
        if _G.SendNotifications == true then
            game:GetService("StarterGui"):SetCore("SendNotification",{
                Title = "BizHub";
                Text = "Tracer successfully loaded.";
                Duration = 5;
            })
        end
    elseif Errored and not Success then
...
Section:NewToggle("Name ESP", "Toggle's Name ESP", function(name)
    local function API_Check()
...
Section:NewToggle("Third Person", "Toggle's third person'", function(value)
    if value then
        game:GetService("Players")["LocalPlayer"].PlayerGui.GUI.Client.Variables.thirdperson.Value = true
    ...
    Section:NewButton("RGB Gun", "Rainbow Gun", function()
        local c = 1 function zigzag(X)  return math.acos(math.cos(X * math.pi)) / math.pi end game:GetService("RunService").RenderStepped:Connect(function()  if game.Workspace.Camera:FindFirstChild('Arms') then   for i,v in pairs(game.Workspace.Camera.Arms:GetDescendants()) do    if v.ClassName == 'MeshPart' then      v.Color = Color3.fromHSV(zigzag(c),1,1)     c = c + .0001    end   end  end end)
    end)

    ------------------------------------------------------------------------
    if isPlayerAllowed(playerId) then
        local Tab = Window:NewTab("VIP")
        local Section = Tab:NewSection("VIP:")
        --VIP Shit Here

        Section:NewButton("Crash Server", "Crashes the server", function()
    ...
    local Section = Tab:NewSection("Dev's:")
    --Credit SHit here

    Section:NewLabel("Bizdrop")
    local Section = Tab:NewSection("VIP's:")
    Section:NewLabel("Joshlord590")

    ------------------------------------------------------------------------
end

function BizHubStrucid()
    ...
    local Window = Library.CreateLib("BizHub V1 | Game: Strucid | Welcome " .. Name, colors)

    local Tab = Window:NewTab("Main")
    local Section = Tab:NewSection("Main:")

    Section:NewToggle("Inf Jump", "Toggle's inf jump", function(thing)
        Jump = thing
	end, {Default = false})

end

function BizHubNUSFA()
    ...
    local Window = Library.CreateLib("BizHub V1 | Game: NUSFA | Welcome " .. Name, colors)

    local Tab = Window:NewTab("Main")
    local Section = Tab:NewSection("Main:")

    Section:NewButton("Heal", "Heal mid game", function()
    ...
    Section:NewButton("Clear Inventory", "Clears your inventory", function()
        player.Backpack:ClearAllChildren()
    end)

    local Tab = Window:NewTab("Character")
    local Section = Tab:NewSection("Character's:")

    Section:NewButton("Sasuke", "Become Sasuke mid game", function()
        local args = {
            [1] = "Sasuke"
        }
    ...
    Section:NewButton("Minato", "Become Minato mid game", function()
        local args = {
            [1] = "Minato"
        }
        game:GetService("ReplicatedStorage").Picked:FireServer(unpack(args))
    ...
    Section:NewButton("Naruto", "Become Naruto mid game", function()
        local args = {
            [1] = "Naruto"
        }
        game:GetService("ReplicatedStorage").Picked:FireServer(unpack(args))
    ...
    Section:NewButton("Gaara", "Become Gaara mid game", function()
        local args = {
            [1] = "Gaara"
        }
        game:GetService("ReplicatedStorage").Picked:FireServer(unpack(args))
    ...
    Section:NewButton("Sakura", "Become Sakura mid game", function()
        local args = {
            [1] = "Sakura"
        }
        game:GetService("ReplicatedStorage").Picked:FireServer(unpack(args))
    ...
    Section:NewButton("Kakashi", "Become Kakashi mid game", function()
        local args = {
            [1] = "Kakashi"
        }
        game:GetService("ReplicatedStorage").Picked:FireServer(unpack(args))
    ...
    Section:NewButton("Naruto TS", "Become Naruto TS mid game", function()
        local args = {
            [1] = "Naruto TS"
        }
        game:GetService("ReplicatedStorage").Picked:FireServer(unpack(args))
    ...
    Section:NewButton("Rock Lee", "Become Rock Lee mid game", function()
        local args = {
            [1] = "Rock Lee"
        }
        game:GetService("ReplicatedStorage").Picked:FireServer(unpack(args))
    ...
    Section:NewButton("Boruto", "Become Boruto mid game", function()
        local args = {
            [1] = "Boruto"
        }
        game:GetService("ReplicatedStorage").Picked:FireServer(unpack(args))
    ...
    Section:NewButton("Neji", "Become Neji mid game", function()
        local args = {
            [1] = "Neji"
        }
        game:GetService("ReplicatedStorage").Picked:FireServer(unpack(args))
    ...
    Section:NewButton("Shikamaru", "Become Shikamaru mid game", function()
        local args = {
            [1] = "Shikamaru"
        }
        game:GetService("ReplicatedStorage").Picked:FireServer(unpack(args))
    ...
    Section:NewButton("Uzrnam33", "Become Uzrnam33 mid game", function()
        local args = {
            [1] = "Uzrnam33"
        }
        game:GetService("ReplicatedStorage").Picked:FireServer(unpack(args))
    ...
    Section:NewButton("Mitsuki", "Become Mitsuki mid game", function()
        local args = {
            [1] = "Mitsuki"
        }
        game:GetService("ReplicatedStorage").Picked:FireServer(unpack(args))
    ...
    Section:NewButton("Shino", "Become Shino mid game", function()
        local args = {
            [1] = "Shino"
        }
        game:GetService("ReplicatedStorage").Picked:FireServer(unpack(args))
    ...
    Section:NewButton("Deidara", "Become Deidara mid game", function()
        local args = {
            [1] = "Deidara"
        }
        game:GetService("ReplicatedStorage").Picked:FireServer(unpack(args))
    ...
    Section:NewButton("L4vaBurst", "Become L4vaBurst mid game", function()
        local args = {
            [1] = "L4vaBurst"
        }
        game:GetService("ReplicatedStorage").Picked:FireServer(unpack(args))
    ...
    Section:NewButton("Madara", "Become Madara mid game", function()
        local args = {
            [1] = "Madara"
        }
        game:GetService("ReplicatedStorage").Picked:FireServer(unpack(args))
    ...
    Section:NewButton("Itachi", "Become Itachi mid game", function()
        local args = {
            [1] = "Itachi"
        }
        game:GetService("ReplicatedStorage").Picked:FireServer(unpack(args))
    ...
    Section:NewButton("Hashirama", "Become Hashirama mid game", function()
        local args = {
            [1] = "Hashirama"
        }
        game:GetService("ReplicatedStorage").Picked:FireServer(unpack(args))
    ...
    local Tab = Window:NewTab("Jutsu")
    local Section = Tab:NewSection("Jutsu's:")

    Section:NewButton("Fire Dragon Roar", "Use Fire Dragon Roar", function()
        game:GetService("ReplicatedStorage").FireDragon_Folder.Remotes.FD_Roar_RE:FireServer()
    end)
...
if game.placeId == 4732886904 then 
    BizHubStrucid()
end

if game.placeId == 125188005 then 
    BizHubNUSFA()
end
